/**
 * Lo mas comun en las funcines tipo collback es usar un arrowfunction
 * 
 * 
 * 
 */
...
// for 'off'   (const variabletemporal of arraydeorigen)
...
// map ejecuta una fucnion sobre cada elemento de un array y devuelve un nuevo array con el resultado
...
// filter sirve para filtrar elementos de un array, recibe una funcion de callback donde lo que retornemos debe ser una expresion booleana, y los elementos del array que cumplan esta condicion seran guradados en un array nuevo
...
console.log(pares);
// ejercicio
const multiploDeTres = numeros.filter(function(numero){
    return numero % 3 === 0;
});
